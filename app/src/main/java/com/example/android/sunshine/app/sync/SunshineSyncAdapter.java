...
import com.example.android.sunshine.app.data.WatchFaceModel;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void notifyWearables() {
        ...
        mapRequest.getDataMap().putString("location", location);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request).setResultCallback(new ResultCallbacks<DataApi.DataItemResult>() {
            ...
            public void onSuccess(DataApi.DataItemResult dataItemResult) {
                Log.d(LOG_TAG, "Success!+unsplashwatchface");
            }

            @Override
            public void onFailure(Status status) {
                Log.d(LOG_TAG, "Failure!+unsplashwatchface");
            }
        });
    ...
    public void sendWeatherInfoToWearable() {
        ...
        putDataMapRequest.getDataMap().putString(KEY_HIGH, highTemp);
        putDataMapRequest.getDataMap().putString(KEY_LOW, lowTemp);
        putDataMapRequest.getDataMap().putInt(KEY_WEATHER_ID, weatherId);
        putDataMapRequest.getDataMap().putString(KEY_LOCATION, location);

        PutDataRequest request = putDataMapRequest.asPutDataRequest();

        Log.d(LOG_TAG, "High:" + highTemp + ", Low:" + lowTemp + ", Condition ID: " + weatherId);
